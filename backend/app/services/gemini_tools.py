...
def build_system_instruction(
    ...
    dynamic_system_instruction = (
        ...
        f"1. For ANY weather questions (current weather, forecasts, temperature, precipitation, even if mentioning 'today', 'tomorrow', or specific days/cities), delegate directly to WeatherAgent.\n"
        ...
        f"5. Daily Briefing: ONLY if the user explicitly asks for a full daily briefing, daily overview, or agenda (e.g., 'what does my day look like?', 'plan for today', 'daily briefing', 'мій день'), delegate first to SecretaryAgent for schedule/tasks and then WeatherAgent for weather to provide a complete daily briefing. Do NOT delegate to SecretaryAgent for queries that are purely about weather.\n"
